...
public class Rating {
    ...
    public Rating(Long id, User user, Store store, Integer rating, LocalDateTime createdAt, LocalDateTime updatedAt) {
        this.id = id;
        this.user = user;
        this.store = store;
        this.rating = rating;
    ...
    public static class RatingBuilder {
        ...
        public Rating build() {
            return new Rating(id, user, store, rating, createdAt, updatedAt);
        }
    }
}
